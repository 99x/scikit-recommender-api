...
*Some of the ideas and wording for the statements above were based on work by [Alamofire](https://github.com/Alamofire/Foundation) [Mozilla](https://wiki.mozilla.org/Code_of_Conduct/Draft), [Ubuntu](http://www.ubuntu.com/about/about-ubuntu/conduct), and [Twitter](https://github.com/twitter/code-of-conduct). We thank them for their work and contributions to the open source community.*